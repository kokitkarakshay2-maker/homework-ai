        ...
        <header className="mb-12 flex justify-between items-center">
          ...
          >
            <div className="w-full h-full rounded-full border-2 border-primary overflow-hidden bg-surface flex items-center justify-center shadow-sm">
              ...
              />
              <span className="hidden font-semibold text-[15px] text-foreground group-hover:text-primary transition-colors">S</span>
            </div>
            <div className="absolute -bottom-0.5 -right-0.5 w-[14px] h-[14px] bg-green-500 rounded-full border-[2.5px] border-[#0a0a0a]" />
          </button>
        </header>
